module Tester where
    ...
    cards = [ "empty", "1C", "2C", "3C", "4C", "5C", "6C", "7C", "8C", "9C", "10C", "11C", "12C", "13C", "1D", "2D", "3D", "4D", "5D", "6D", "7D", "8D", "9D", "10D", "11D", "12D", "13D", "1H", "2H", "3H", "4H", "5H", "6H", "7H", "8H", "9H", "10H", "11H", "12H", "13H", "1S", "2S", "3S", "4S", "5S", "6S", "7S", "8S", "9S", "10S", "11S", "12S", "13S" ]

    sort [] = []
    sort (x:xs) = sort [ y | y <- xs, y <= x ] ++ [x] ++ sort [ y | y <- xs, y > x ]
    replace hand = [ cards !! x | x <- hand ]
    ...
    perms = [ 
        ...
        [ 1,  9,  42, 43, 23, 37, 25, 39, 5  ]] -- 11  9-K straight VS 10-A straight

    solns = [ 
        [ "2C",  "3C",  "4C",  "5C",  "6C"  ], -- 1   2-6 straight flush
        ...
        [ "1H",  "1S"                       ], -- 10  A-pair
        [ "10D", "11H", "12D", "13H", "1C"  ]] -- 11  10-A straight

    evaluate 0 = return ()
    evaluate n = do
        let cardTester = perms !! (length perms - n)
        let userAnswer = sort $ deal $ cardTester
        let realAnswer = sort $ solns !! (length perms - n)
        
        printf "TEST %d\n" (length perms - n + 1)

        printf "Player 1 Hand: "
        print (replace [cardTester !! 0, cardTester !! 2])

        printf "Player 2 Hand: "
        print (replace [cardTester !! 1, cardTester !! 3])

        printf "Table Hand:    "
        print (replace $ tail $ tail $ tail $ tail cardTester)
